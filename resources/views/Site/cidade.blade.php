...
@section('content')
    <form id="_files">
        <input type="file" onchange="console.log({e:this})">
    </form>
    <article class="article">
        <section class="article__content"  >
            ...
            <p class="breadcrumb">$Continent/$pais/$cidade</p>

            {{--<div data-editable>--}}
                {{--<img src="/Site/media/images/banner.jpg" data-editable data-name="imgteste" alt="imagem de teste">--}}
            {{--</div>--}}
